...
playerButton.addEventListener(
    ...
    async function() {
        ...
        if (
            typeof window.startGoogleLogin !==
            "function"
        ) {

            console.error(
                "❌ Firebase login is not ready."
            );


            alert(
                "Google login is not ready. Please refresh the page and try again."
            );
        ...
        try {
            ...
            if (
                ...
                alert(
                    "This website domain is not authorized in Firebase. Add sanndrean.github.io to Firebase Authentication > Settings > Authorized domains."
                );
            ...
            alert(
                "Google login failed. Check the browser console for the error."
            );
